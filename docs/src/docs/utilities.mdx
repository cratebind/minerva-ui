...
Utility props are provided as aliases for most components.

The style is heavily influenced by [Tailwind CSS](https://tailwindcss.com/docs/utility-first) "utility classes", which are

They also provide preset "contraints" designed control the CSS you write and avoid "hard coding" all CSS values.
