  ...
  return (
    <MenuContainer>
      ...
      <MenuList menuPosition="right">
        <MenuItem
          color={selectedItem === 'edit_profile' ? '#651FFF' : '#000'}
          fontWeight={selectedItem === 'edit_profile' ? 'bold' : 'normal'}
          onSelect={item => setSelectedItem('edit_profile')}
        >
          Edit Profile
        </MenuItem>
        <MenuItem
          color={selectedItem === 'settings' ? '#651FFF' : '#000'}
          fontWeight={selectedItem === 'settings' ? 'bold' : 'normal'}
          onSelect={item => setSelectedItem('settings')}
        >
          Settings
        </MenuItem>
      </MenuList>
